    ...
    var formated_result = ""
                ...
                // res.send(table);
                    ...
                    async function create_table(){
                            ...
                            table +=`<thead><tr><th class="name-head">SKU/part name</th><th class="code-head">supplier code</th><th class="description-head">description</th><th class="quantity-head">quantity</th><th class="price-head">price</th></tr></thead>`
                            for(i=1;i<=row_number; i++){
                                ...
                                table +=`<tr><td><div class="autocomplete top" ><input class="table-input name" id='${i}_0a' name='r${i}_c0a' type="text"  value='${content[i][1]}' onblur="auto_name('${i}_0')"  placeholder="SKU"></div>`       
                                table +=`<div class="autocomplete" ><input class="table-input name" id='${i}_0b' name='r${i}_c0b' type="text"  value='${content[i][2]}'  placeholder="part name"></div></td>`
                                table +=`<td class="code"><input type='text' name='r${i}_c1' id='r${i}_c1' value='${content[i][0]}' hidden>${content[i][0]}</td>`
                                table +=`<td><input type='text' name='r${i}_c2' id='r${i}_c2' value='${content[i][3]}' hidden>${content[i][3]}</td>`
                                table +=`<td><input type='text' name='r${i}_c3' class="table-input quantity" id='r${i}_c3' value='${content[i][4]}' ></td>`
                                table +=`<td><input type='text' name='r${i}_c4' class="table-input price" id='r${i}_c4' value='${content[i][5]}' ></td></tr>`
